...
export async function getAuthInstance() {
  ...
  const { initializeApp, getApps } = await import(
    /* webpackIgnore: true */ /* turbopackIgnore: true */ `https://www.gstatic.com/firebasejs/${FB_VERSION}/firebase-app.js`
  );
  const { getAuth } = await import(
    /* webpackIgnore: true */ /* turbopackIgnore: true */ `https://www.gstatic.com/firebasejs/${FB_VERSION}/firebase-auth.js`
  );
...
export async function getDbInstance() {
  ...
  const { getFirestore } = await import(
    /* webpackIgnore: true */ /* turbopackIgnore: true */ `https://www.gstatic.com/firebasejs/${FB_VERSION}/firebase-firestore.js`
  );
  const app = getApps().length ? getApps()[0] : initializeApp(firebaseConfig);
